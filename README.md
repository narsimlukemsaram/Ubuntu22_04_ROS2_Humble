...
**Step 1: Download the Ubuntu 22.04 iso image file from https://releases.ubuntu.com/jammy/** 

**Step 2: Install Rufus using https://rufus.ie/en/**

**Step 3: Create a bootable Ubuntu 22.04 USB drive using Rufus.** Note: Ensure your bootable Ubuntu 22.04 USB drive is ready.
